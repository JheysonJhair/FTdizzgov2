...
const Chat = () => {
  ...
  const onSend = async (newMessages = [], image = null) => {
    try {
      if (newMessages === "" && !image) {
        ...
        await sendMessage(userId, newMessages, image);
  ...
  const handleChoosePhoto = async () => {
    ...
    if (permissionResult.granted === false) {
      alert("Permiso para acceder a la galería de imágenes necesario");
      return;
    }
